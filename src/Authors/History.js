...
function History() {
  return (
    <div id="author">
        ...
        <p>
            Modyfikacja została stworzona przez Bartłomieja Grochowskiego o&nbsp;nicku 'TheKetrab'. Biedak tworzył tego moda
            ...
            jako dowód zaufania. Została też konwencja nazywania nowych NPC (NASZ_numer_imie) i&nbsp;przedmiotów (ItNa_instancja),
        ...
        <p>
            ...
            Bartłomiej dobierał się do komputera z&nbsp;zainstalowanym Gothiciem, słuchał muzyki z Risena&nbsp;1, wstawiał
            pojedyncze postacie, dialogi, misje i&nbsp;itemy. Po roku przeniósł się na swój komputer i&nbsp;rozwój modyfikacji znacznie
            przyśpieszył. W połowie 2015. roku na YT pojawił się krótki gameplay, prezentujący quest z&nbsp;pierwszego rozdziału
            (Aran&nbsp;-&nbsp;towarzystwo). Jakiś czas później TheKetrab udostępnił wersję Alpha z&nbsp;pierwszym rozdziałem (w&nbsp;celach betatestu).
        ...
        <p>
            ...
            i&nbsp;naprawić dziury w logice fabuły. Data premiery szacowana była na styczeń 2019. roku. Po półrocznej współpracy
            TheKetrab znów został sam i&nbsp;starał się dopracować szczegóły. W październiku 2018. roku mod zyskał nową nadzieję,
            ponieważ pracami nad Ucieczką zainteresował się Bogu, który specjalizuje się w skryptach znacznie poważniejszych niż
            pisanie zadań. Rok 2019 był niezwykle trudny, ponieważ kolejne betatesty pokazywały nowe błędy i trzeba było przeznaczać
            szmat czasu na ich poprawę. Co więcej, TheKetrab zajął się prowadzeniem prac dubbingowych, co trwało 4 miesiące.
            Powoli wszystko zmierzało ku końcowi, jednakże problemem okazał się być deadline. Autor wyjeżdżał na 100 dni do USA,
            więc istniały dwa możliwe scenariusze: Zdążymy ukończyć Ucieczkę przed 15 czerwca albo Ucieczka zostanie wydana w październiku.
            Ta druga opcja była bardzo smutna, ponieważ celem było dać modyfikację graczom na wakacje. Dlatego dzięki mobilizacji
        ...
        <p>
            'Pamiętam, że wyrwałem się z pracy około 17:30 (czasu Nowego Jorku) i pobiegłem na wysoką górę, która była jedynym miejscem
            w pobliżu z zasięgiem. Usiadłem na skale i pisałem na telefonie z Maciey'em, który publikował modyfikację.
            Nie miałem dostępu do komputera, a co dopiero do plików ze swoim modem, dlatego w wersji 1.0 pojawiły się takie przykre bugi
            jak chociażby nieprzenikające liście drzew albo nieaktywujący się rozdział 4.' ~TheKetrab.
        </p>
        <p>
            Z powodu nieobecności autora modyfikacji, patronat nad grą przejął bogu i odpowiadał na wszystkie pytania
            graczy oraz wydawał łatki do ostatecznej wersji moda. W paździeniku rozpoczęto prace nad wersją 1.1.
            ...
            do nowszych, stabilniejszych wersji i po kolejnych trzech miesiącach ciężkiej pracy, gra została opublikowana ponownie.
        </p>
    </div>
